...
async function main() {
  ...
  await prisma.checklistItem.createMany({
    data: [
      { title: 'Research Auth0 documentation', taskId: task1.id, position: 0, completed: true },
      { title: 'Set up Auth0 application', taskId: task1.id, position: 1, completed: true },
      { title: 'Implement login flow', taskId: task1.id, position: 2, completed: false },
      { title: 'Add logout functionality', taskId: task1.id, position: 3, completed: false },
      { title: 'Test authentication flow', taskId: task1.id, position: 4, completed: false },
    ],
  });
  ...
  await prisma.comment.createMany({
    data: [
      {
        content: 'Started working on the Auth0 integration. Making good progress!',
        taskId: task1.id,
        userId: user2.id,
      },
      {
