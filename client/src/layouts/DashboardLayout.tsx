...
const navItems = [
  ...
  { path: '/boards', label: 'My Boards', icon: <CheckSquare size={20} /> },
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <motion.aside 
        ...
        className={cn(
          "fixed md:relative w-64 md:w-64 h-full z-20 md:z-0 bg-white dark:bg-gray-800 shadow-lg md:shadow-none",
      ...
      >
        ...
        <div className="p-4 h-16 flex items-center justify-between border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2">
            ...
            {isSidebarOpen && <span className="font-semibold text-lg">TaskNest</span>}
          </div>
          <button 
        ...
        {isSidebarOpen && (
          <div className="px-4 mt-6">
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-md p-2">
              <h3 className="text-xs uppercase text-gray-500 dark:text-gray-400 font-medium mb-2 px-2">Appearance</h3>
              <div className="grid grid-cols-3 gap-1">
                <button
                  onClick={() => handleThemeChange('light')}
                  className={cn(
                    "flex flex-col items-center justify-center p-2 rounded",
                    theme === 'light' ? "bg-white dark:bg-gray-600 shadow-sm" : "hover:bg-gray-100 dark:hover:bg-gray-700"
                  )}
                >
                  <Sun size={16} />
                ...
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center justify-center p-2 rounded",
                    theme === 'dark' ? "bg-white dark:bg-gray-600 shadow-sm" : "hover:bg-gray-100 dark:hover:bg-gray-700"
                  )}
                >
                  <Moon size={16} />
                ...
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center justify-center p-2 rounded",
                    theme === 'system' ? "bg-white dark:bg-gray-600 shadow-sm" : "hover:bg-gray-100 dark:hover:bg-gray-700"
                  )}
                >
                  <Monitor size={16} />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-2">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 truncate w-32">{user?.email || 'user@example.com'}</p>
                </div>
              </div>
              <button 
